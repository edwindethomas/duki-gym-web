            ...
            <div class="col-md-12">
                <form method="POST">
                    <div class="form-group">
                        <h2 class="entrenador__titulo mt-5" id="viewclients">Agregar Entrenador</h2>
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-black" name="btnAgregarEntrenador">Agregar Entrenador</button>
                </form>
            </div>
        </div>
