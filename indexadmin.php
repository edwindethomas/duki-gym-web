                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo '<a href="editarcliente.php?id='.$entrenador[0].'" class="btn btn-primary" >Editar</a>'?></td>
                            <td><?php echo '<a href="eliminarcliente.php?id='.$entrenador[0].'" class="btn btn-danger" >Borrar</a>'?></td>
                        </tr>
                        <?php
                           }
                        ?>
