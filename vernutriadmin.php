...
$nutriologos = select_nutriologoss();
?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mt-5">
                <h2 class="entrenador__titulo" id="viewclients">Lista de nutriologos</h2>
                <table class="table">
                    <thead>
                        <tr>
                            <th>Id</th>
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td><?php echo $nutriologo[0] ?></td>
                            <td><?php echo $nutriologo[1] ?></td>
                            <td><?php echo $nutriologo[2] ?></td>
